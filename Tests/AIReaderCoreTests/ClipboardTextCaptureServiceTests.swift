...
final class ClipboardTextCaptureServiceTests: XCTestCase {
  ...
  func testMissingClipboardTextThrows() throws {
    let service = ClipboardTextCaptureService(clipboardProvider: TestClipboardProvider(text: nil))
  ...
  func testWhitespaceClipboardTextThrows() throws {
    let service = ClipboardTextCaptureService(clipboardProvider: TestClipboardProvider(text: " \n\t "))
